...
const developers = [
  ...
  { slug: 'nc-team', name: 'NC Team', fullName: 'NC Team (Smartbot Pro)', cases: 4, type: 'Конструктор', site: 'https://ncteam.io/', brands: ['Пятёрочка/X5', 'ВкусВилл', 'Flowwow', 'VK Маркет'], description: 'Проектный офис по разработке чат-ботов. С 2025 года развивают направление вайбкодинга.' },
